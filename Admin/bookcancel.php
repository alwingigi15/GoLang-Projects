...
$sql = "SELECT * FROM booking b,employee  e, customer c where b.emp_id=e.emp_id and b.cust_id=c.cust_id and book_status='cancel'";
...
if(isset($_POST['okay']))
{
     //echo"<script> location.replace('bookingreports.php'); </script>";
}
?>
<!DOCTYPE html>
<html lang="en">
...
<body><br><br><br>
        ...
        <h2 class="text-center p-5"><b>Cancel Booking Reports</b></h2><br>
