...
<head>
	<title> a Corporate Category Flat Bootstrap Responsive Website Template | Home :: w3layouts</title>
	<!-- for-mobile-apps -->
		...
		<div class="container">
			...
			<div class="logo-nav-agileits">
				...
				<div class="header-grid-left-wthree">
					...
					<ul>
						<li>
							<span class="fa fa-envelope" aria-hidden="true">Admin@gmail.com</span>
	...
	<div class="cpy-footer">
		...
		<div class="cpy-text">
			<p>© 2023 A2Z. All rights reserved | Design by
				<a href="https://www.linkedin.com/in/jose-antony-7937ba249/">Jose Antony</a>
