...
WHERE book_status='booked' and b.b_status='pending'
...
<body><br><br><br>
        ...
        <h2 class="text-center p-5"><b>Pending Booking Reports</b></h2><br>
...
echo"<script >location.href = 'Rhead.php'</script>";
        ...
        <input type="submit" value="print" onclick="window.print()" id="printTable" onclick="printData();" class="btn btn-primary">
       </form></body></html>
