...
<head>
	<title> a Corporate Category Flat Bootstrap Responsive Website Template | Home</title>
	<!-- for-mobile-apps -->
		...
		<div class="container">
			...
			<div class="logo-nav-agileits">
				<div class="logo-nav-left">
					<h1>
						<a href="index.html">
							...
							<span class="logo-title">Home Serve</span>
							<span class="logo-title">HANDYMAN SERIVCES</span>
						</a>
					</h1>
				</div>
				...
				<div class="header-grid-left-wthree">
					...
					<ul>
						<li>
							<span class="fa fa-envelope" aria-hidden="true">Homeservices.com</span>
							<a href="mailto:info@example.com"></a>
						</li>
						<li>
							<span class="fa fa-phone" aria-hidden="true"></span>0480-2773317</li>
						<li>
							<span class="fa fa-mobile" aria-hidden="true"></span>+91-1223456785
						</li>
					</ul>
			...
			<ul>
					...
					<div class="banner-top banner-top1">
						<div class="container">
							<div class="banner-info info2">
								<h3>The Leading Professional Handyman Services</h3>
				...
				<li>
					<div class="banner-top banner-top3">
						<div class="container">
							<div class="banner-info banner-bg3">
		...
		<div class="container">
			<div class="main-bottom">
				...
				<div class="col-md-6 col-sm-6 mb-right">
					...
					<a href="index2.php">view all services</a>
				</div>
	...
	<div class="cpy-footer">
		...
		<div class="cpy-text">
			<p>© 2023 A2Z. All rights reserved | Design by
				...
				<a href="../admin/index.php">-The Admin Login</a>
			</p>
		</div>
