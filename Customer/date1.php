...
$rules=array(
    ...
    "from_date"=>array('required'=>true,'date'=>array('from'=>'today','to'=>'7 days 12 am')),
 ...
 <div class="row">
			<div class="col-md-8">
				<div class="form-group">
					...
					<input type="submit" name="btn_insert" value="Book Your Day" class="btn btn-success btn-block" class="text-center p-5">
				</div>
