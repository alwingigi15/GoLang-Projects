...
$sql = "SELECT emp_img,emp_firstname,emp_lastname,dob,age,gender,emp_address,area_id,city,phn_no,emp_email,catid,emp_password,emp_desc,emp_exp FROM employee WHERE emp_email=mariya@gmail.com";
...
$sql =" UPDATE employee SET emp_firstname='$emp_firstname',emp_lastname='$emp_lastname',age='$age',emp_address='$emp_address',city='$city',area_id='$area_id',phn_no='$phn_no',emp_exp='$emp_exp' WHERE emp_email=".$emp_email;
