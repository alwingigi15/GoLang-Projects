...
<?php
	...
	$file=new FileUpload();
$elements=array("emp_firstname"=>"","emp_lastname"=>"","emp_address"=>"","area"=>"","gender"=>"","dob"=>"","age"=>"","city"=>"","phno"=>"","emp_img"=>"","emp_email"=>"","emp_password"=>"","cpass"=>"","catid"=>"","emp_desc"=>"","catid"=>"","emp_desc"=>"","emp_exp"=>"");
...
$labels=array("emp_firstname"=>"employee firstname","emp_lastname"=>"employee lastname","emp_address"=>"addrress","area"=>"location","gender"=>"gender","dob"=>"dob","age"=>"age","city"=>"city","phno"=>"mobile no","emp_img"=>"image of employee","emp_email"=>"email id","emp_password"=>"password","cpass"=>"confirm passwrod","catid"=>"job id","emp_desc"=>"descripition","emp_exp"=>"experience");
...
$rules=array("emp_firstname"=>array("required"=>true,"minlength"=>3,"maxlength"=>30,"alphaonly"=>true),
  ...
  "gender"=>array("required"=>true,"exist"=>array("m","f")),
	...
	"city"=>array("required"=>true,"minlength"=>3,"maxlength"=>30,"alphaonly"=>true),
	 ...
	 "phno"=>array("required"=>true,"minlength"=>3,"maxlength"=>30,"integeronly"=>true),
    ...
    "cpass"=>array("required"=>true,"minlength"=>3,"maxlength"=>10,"compare"=>array("comparewith"=>"emp_password","operator"=>"=")),
	 ...
	 "emp_desc"=>array("required"=>true,"minlength"=>1,"maxlength"=>50),
...
<span style="color:red;"><?= $validator->error('emp_desc'); ?></span>
	...
	<div class="row">
                    <div class="col-md-12">
                    <div class="form-group">
<label for="">Your work Experience:</label><br>

<?= $form->textArea('emp_exp',array('class'=>'form-control')); ?>
