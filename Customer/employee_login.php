...
if(isset($_POST['login']))
{
    if($validator->validate($_POST))
    {
        ...
        $data=array('emp_email'=>$_POST['emp_email'],'emp_password'=>$_POST['emp_password'],'status'=>'Approved');
		$condition="status='Approved'";
        if($info=$dao->login($data,'employee',$condition))
        {
           
            $_SESSION['emp_email']=$info['emp_email'];
            $_SESSION['emp_id']=$info['emp_id'];
            $_SESSION['emp_firstname']=$info['emp_firstname'];

$a=$_SESSION['emp_email'];
$b=$_SESSION['emp_id'];
$d=$_SESSION['emp_firstname'];
		...
		<div class="container">
			...
			<div class="col-md-6">
				<div class="form-group">
					...
					<input type="text" name="emp_email" required pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$" title="Must be a valid email" placeholder="xxx@xx.com" class="form-control">
				</div>
			</div>
				<div class="col-md-6">
				<div class="form-group">
...
<div class="col-md-6">
				<div class="form-group">
					<label for="">Are You a new Employee?</label>
					<a href="emp_register.php">Sign Up </a>
				</div>
			</div>
