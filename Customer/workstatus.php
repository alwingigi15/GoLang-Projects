...
$e = $_SESSION['emp_id'] ?? '';
//echo $e;
$sql = "SELECT * FROM booking as b INNER JOIN customer as c ON b.cust_id=c.cust_id WHERE b_status='accept' AND emp_id = ?";
$stmt = $conn->prepare($sql);
$stmt->bind_param("i", $e);  // Assuming emp_id is an integer, adjust the type accordingly
$stmt->execute();
